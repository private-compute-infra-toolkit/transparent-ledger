...
"""TLedger-specific wrappers for AWS enclave AMI generation."""

load("@rules_aws//build_defs/aws/enclave:aws_eif_and_ami.bzl", "aws_eif_and_ami")

def tledger_aws_eif_and_ami(
        name,
    ...
    Args:
        ...
        extra_jvm_options: Extra JVM options to append to standard TLedger defaults.
